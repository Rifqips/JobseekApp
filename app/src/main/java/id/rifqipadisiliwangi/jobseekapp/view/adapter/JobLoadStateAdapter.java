...
import id.rifqipadisiliwangi.jobseekapp.databinding.LoadStateItemBinding;

public class JobLoadStateAdapter extends LoadStateAdapter<JobLoadStateAdapter.LoadStateViewHolder> {
    // Define Retry Callback
    private View.OnClickListener mRetryCallback;

    public JobLoadStateAdapter(View.OnClickListener retryCallback) {
        // Init Retry Callback
